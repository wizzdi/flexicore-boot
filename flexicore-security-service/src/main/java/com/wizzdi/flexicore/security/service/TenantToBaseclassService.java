...
public class TenantToBaseclassService implements Plugin {
	...
	public TenantToBaseclass createTenantToBaseclass(TenantToBaseclassCreate tenantToBaseclassCreate, SecurityContextBase securityContext){
	...
	public TenantToBaseclass createTenantToBaseclassNoMerge(TenantToBaseclassCreate tenantToBaseclassCreate, SecurityContextBase securityContext){
	...
	public TenantToBaseclass updateTenantToBaseclass(TenantToBaseclassUpdate tenantToBaseclassUpdate, SecurityContextBase securityContext){
	...
	public PaginationResponse<TenantToBaseclass> getAllTenantToBaseclasss(TenantToBaseclassFilter tenantToBaseclassFilter, SecurityContextBase securityContext) {
