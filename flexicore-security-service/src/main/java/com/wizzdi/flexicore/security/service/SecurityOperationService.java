...
public class SecurityOperationService implements Plugin {
	...
	public SecurityOperation createOperation(SecurityOperationCreate operationCreate, SecurityContext securityContext){
	...
	public SecurityOperation createOperationNoMerge(SecurityOperationCreate operationCreate, SecurityContext securityContext){
	...
	public SecurityOperation updateOperation(SecurityOperationUpdate operationUpdate, SecurityContext securityContext){
	...
	public PaginationResponse<SecurityOperation> getAllOperations(SecurityOperationFilter operationFilter, SecurityContext securityContext) {
