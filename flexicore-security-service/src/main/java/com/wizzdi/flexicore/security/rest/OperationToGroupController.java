...
public class OperationToGroupController implements Plugin {
    ...
    @PostMapping("/create")
    public OperationToGroup create(@RequestBody @Validated(Create.class) OperationToGroupCreate operationToGroupCreate, @RequestAttribute SecurityContextBase securityContext) {
    ...
    @PostMapping("/getAll")
    public PaginationResponse<OperationToGroup> getAll(@RequestBody @Valid OperationToGroupFilter operationToGroupFilter, @RequestAttribute SecurityContextBase securityContext) {
    ...
    @PutMapping("/update")
    public OperationToGroup update(@RequestBody @Validated(Update.class) OperationToGroupUpdate operationToGroupUpdate, @RequestAttribute SecurityContextBase securityContext) {
